            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        ...
                        <a class="nav-link mx-2" href="{{ $homeRoute }}"><i class="fas fa-home me-1"></i> Beranda</a>
                    </li>
                </ul>
                <div class="d-flex">
                    <div class="dropdown">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <div class="profile-info">
                                ...
                                <h3 id="profileName" class="mb-1">{{ $username }}</h3>
                ...
                <div class="modal-body">
                    <form id="editProfileForm">
                        ...
                        <div class="mb-3">
                            ...
                            {{-- <input type="text" class="form-control" id="profileNameInput" name="nama" value="{{ old('nama', $user->nama ?? '') }}"> --}}
                            <input type="text" class="form-control" id="profileNameInput" name="nama" value="{{ old('nama', $user['nama'] ?? '') }}">
                        </div>
                        <div class="mb-3">
                            <label for="profileLocationInput" class="form-label">Alamat</label>
                            {{-- <input type="text" class="form-control" id="profileLocationInput" name="address" value="{{ old('address', $user->address ?? '') }}"> --}}
                            <input type="text" class="form-control" id="profileLocationInput" name="address" value="{{ old('address', $user['address'] ?? '') }}">
                        </div>
                        <div class="mb-3">
                            <label for="profileBioInput" class="form-label">Bio</label>
                            {{-- <textarea class="form-control" id="profileBioInput" name="bio" rows="3"> {{ old('bio', $user->bio ?? '') }} </textarea> --}}
                            <textarea class="form-control" id="profileBioInput" name="bio" rows="3"> {{ old('bio', $user['bio'] ?? '') }} </textarea>
                        </div>
                        <div class="mb-3">
                            <label for="profilePhoneInput" class="form-label">Nomor Telepon</label>
                            {{-- <input type="tel" class="form-control" id="profilePhoneInput" name="phone" value="{{ old('phone', $user->phone ?? '') }}"> --}}
                            <input type="tel" class="form-control" id="profilePhoneInput" name="phone" value="{{ old('phone', $user['phone'] ?? '') }}">
                        </div>
                    </form>
                </div>
