        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="sidebar-menu-item">
                    <a href="{{ route('admin') }}" class="sidebar-menu-link">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="user-info">
                                                    ...
                                                    <div>
                                                        <h6 class="user-name">{{ $user->nama ?? 'null' }}</h6>
                                                        <p class="user-email">{{ $user->email ?? 'null' }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="user-address">{{ $user->address ?? 'null' }}</td> <!-- Alamat -->
                                            <td class="user-bio">{{ $user->bio ?? 'null' }}</td> <!-- Bio -->
                                            <td class="user-phone">{{ $user->phone ?? 'null' }}</td> <!-- No Telepon -->
                                            <td>{{ $user->created_at ? \Carbon\Carbon::parse($user->created_at)->format('d M Y') : 'null' }}</td> <!-- Tanggal Terdaftar -->
                                            <td>
                                                <div class="table-actions"> 
                                                    ...
                                                    <button class="action-btn action-btn-delete" title="Hapus Pengguna" data-id="{{ $user->id }}">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addUserForm" method="POST" action="{{ route('user.store') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        <div class="row mb-4">
